    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "img1_tips": ("STRING", {"default": "请上传参考图片","multiline": False}),
                "img2_tips": ("STRING", {"default": "请上传参考图片","multiline": False}),
                "img3_tips": ("STRING", {"default": "请上传参考图片","multiline": False}),
                "video1_tips": ("STRING", {"default": "请上传参考视频","multiline": False}),
                "video2_tips": ("STRING", {"default": "请上传参考视频","multiline": False}),
                "video3_tips": ("STRING", {"default": "请上传参考视频","multiline": False}),
                "text1_tips": ("STRING", {"default": "请输入文本提示词","multiline": False}),
                "text2_tips": ("STRING", {"default": "请输入反向提示词","multiline": False}),
                "text3_tips": ("STRING", {"default": "请输入文本提示词","multiline": False}),
            },
